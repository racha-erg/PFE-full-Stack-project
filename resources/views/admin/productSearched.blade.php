...
@section('bodyContent')
    <div class="app-content">
          <div class="app-content-header">
            ...
            <a href="{{ route('admin.create') }}" class="btn btn-primary btn-sm m-3 app-content-headerButton" >
              Ajouter un produit</a>
          </div>
          <div class="app-content-actions">
            <form action="{{ route('admin.dashSearch') }}" method="GET">
              <input class="search-bar" placeholder="Search..." type="text"  name="querydash">
              </form>
          ...
          <div class="products-area-wrapper tableView">
            ...
            <div class="products-area-wrapper tableView">
             ...
             @foreach ($results as $product)
                ...
                <div class="product-cell category"><span class="cell-label">Category:</span>{{ $product->category_id }}</div>
                <div class="product-cell stock"><span class="cell-label">Stock:</span>{{$product->quantity}}</div>
                <div class="product-cell price"><span class="cell-label">Price:</span>{{ $product->price }} dh</div>
              </div> 
             @endforeach
